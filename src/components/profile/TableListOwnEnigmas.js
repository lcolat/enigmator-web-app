...
import {FirstPage, KeyboardArrowLeft, KeyboardArrowRight, LastPage, DeleteForever} from '@material-ui/icons';
	...
	render() {
		...
		return (
			<div className={classes.root}>
				...
				>
					{theme.direction === 'rtl' ? <KeyboardArrowRight fontSize={"small"}/> :
				...
				>
					{theme.direction === 'rtl' ? <KeyboardArrowLeft fontSize={"small"}/> :
					...
					<div className={classes.tableWrapper}>
						<Table className={classes.table}>
							<TableHead>
								...
								<TableCell align="left" style={{height: 26}}>Date of Creation</TableCell>
							...
							<TableBody>
								{rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(row => (
									<TableRow key={row.id} hover>
										...
										<TableCell scope={"row"} align={"left"}>{row.date}</TableCell>
